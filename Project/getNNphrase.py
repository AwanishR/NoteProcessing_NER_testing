...
print "Nout extractor running ..."
fileTreeBankRead  = open ("testing/output/set1/treeBank.txt","r")
nounOutFile = open ("testing/output/set1/noun.txt","w")
noteNum = 1
...
print ("\nNoun extraction completed!!!")
print "Total Nouns extracted::"+str(nounCount)
