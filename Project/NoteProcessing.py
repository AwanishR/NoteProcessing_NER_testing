...
noteFile = open ('testing/test_data/set1/test_data.txt','r')
#Opens output file for writing
fileToWrite = open("testing/output/set1/processednotes.txt","w")
#Opens tree bank file for writing
fileTreeBank  = open ("testing/output/set1/treeBank.txt","w+")
